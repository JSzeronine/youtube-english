...
const repeat = [
    {
        ...
        words: [
            { 
                sentence: "I like many sport.", 
                translation: "나는 여러 /운동/을 좋아해요.", 
                w: "sport", 
                k: "운동" 
            },
            { 
                sentence: "Let’s exercise together.", 
                translation: "우리 같이 /운동해요/.", 
                w: "exercise", 
                k: "운동하다" 
            },
            { 
                sentence: "This game is fun.", 
                translation: "이 /게임/은 재미있어요.", 
                w: "game", 
                k: "게임" 
            },
            { 
                sentence: "I play baseball.", 
                translation: "나는 /야구/를 해요.", 
                w: "baseball", 
                k: "야구" 
            },
            { 
                sentence: "We play volleyball.", 
                translation: "우리는 /배구/를 해요.", 
                w: "volleyball", 
                k: "배구" 
            },
        ]
