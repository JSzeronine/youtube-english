...
const repeat = [
    {
        ...
        words: [
            { 
                sentence: "These toys are different colors.", 
                translation: "이 장난감들은 /다른/ 색이에요.", 
                w: "different", 
                k: "다른" 
            },
            { 
                sentence: "Let’s play together!", 
                translation: "우리 /함께/ 놀아요!", 
                w: "together", 
                k: "함께" 
            },
            { 
                sentence: "I have a small cat.", 
                translation: "나는 /작은/ 고양이가 있어요.", 
                w: "small", 
                k: "작은" 
            },
            { 
            ...
            { 
                sentence: "We have the same shoes!", 
                translation: "우리는 /똑같은/ 신발을 신었어요!", 
                w: "same", 
                k: "같은" 
            },
        ]
...
📘 These toys are different colors.
→ 이 장난감들은 다른 색이에요!
