...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "I will help you.", translation: "내가 도와/줄게요.", w: "will" },
            { sentence: "I ate the whole cake.", translation: "나는 케이크를 /전부/ 먹었어요.", w: "whole" },
            { sentence: "I found a coin.", translation: "나는 /동전/을 찾았어요.", w: "coin" },
            { sentence: "I carry my bag.", translation: "나는 가방을 /들어요./", w: "carry" },
            { sentence: "The wind is strong.", translation: "/바람/이 세게 불어요.", w: "wind" },
            { sentence: "The cat is inside the box.", translation: "고양이는 상자 /안에/ 있어요.", w: "inside" },
            { sentence: "I am tired now.", translation: "나는 지금 /피곤해요./", w: "tired" },
        ]
    }
]
