...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "I got a message from Mom.", translation: "엄마에게서 /메시지/를 받았어요.", w: "message" },
            { sentence: "You are so beautiful.", translation: "너는 정말 /예뻐요./", w: "beautiful" },
            { sentence: "Here is your ticket.", translation: "여기 네 /티켓/이에요.", w: "ticket" },
            { sentence: "We go on a tour.", translation: "우리는 /구경/하러 가요.", w: "tour" },
            { sentence: "This is my passport.", translation: "이건 내 /여권/이에요.", w: "passport" },
            { sentence: "The trip was fun.", translation: "그 /여행/은 재미있었어요.", w: "trip" },
            { sentence: "The chair is made of wood.", translation: "의자는 /나무/로 만들어졌어요.", w: "wood" },
        ]
    }
]
