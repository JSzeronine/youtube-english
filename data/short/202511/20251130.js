...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "Which one do you want?", translation: "/어느 것/을 원하나요?", w: "which" },
            { sentence: "Why are you sad?", translation: "/왜/ 슬퍼요?", w: "why" },
            { sentence: "I have many friends.", translation: "나는 /많은/ 친구들이 있어요.", w: "many" },
            { sentence: "I want some juice.", translation: "나는 /조금의/ 주스를 원해요.", w: "some" },
            { sentence: "The cup has little water.", translation: "컵에 물이 /조금/ 있어요.", w: "little" },
        ]
    }
]
