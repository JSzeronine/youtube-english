...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "Sit on the chair.", translation: "의자에 /앉아요./", w: "sit" },
            { sentence: "Let’s talk, Mom.", translation: "엄마, /이야기해요./", w: "talk" },
            { sentence: "Dad is at home.", translation: "/아빠/는 집에 있어요.", w: "dad" },
            { sentence: "I like apples.", translation: "나는 사과를 /좋아해요./", w: "like" },
            { sentence: "Let’s walk to school.", translation: "학교까지 /걸어요./", w: "walk" },
            { sentence: "This word is easy.", translation: "이 /단어/는 쉬워요.", w: "word" },
            { sentence: "I wish for a toy.", translation: "나는 장난감을 /갖고 싶어요./", w: "wish" },
        ]
    },
    {
        word: "Repeat",
        translation: "복습해볼게요.",
        words: [
            { sentence: "Sit beside me.", translation: "내 옆에 /앉아요./", w: "sit" },
            { sentence: "We talk every day.", translation: "우리는 매일 /이야기해요./", w: "talk" },
            { sentence: "Dad cooks dinner.", translation: "/아빠/가 저녁을 만들어요.", w: "dad" },
            { sentence: "I like my cat.", translation: "나는 내 고양이를 /좋아해요./", w: "like" },
            { sentence: "Walk slowly, please.", translation: "천천히 /걸어요./", w: "walk" },
            { sentence: "I can read this word.", translation: "나는 이 /단어/를 읽을 수 있어요.", w: "word" },
            { sentence: "I wish for a sunny day.", translation: "나는 맑은 날씨를 /바래요./", w: "wish" },
        ]
    }
]
