...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "The soup is warm.", translation: "수프가 /따뜻해요./", w: "warm" },
            { sentence: "The house is large.", translation: "그 집은 /커요./", w: "large" },
            { sentence: "I have a few toys.", translation: "나는 /조금의/ 장난감을 가지고 있어요.", w: "few" },
            { sentence: "I am late today.", translation: "나는 오늘 /늦었어요./", w: "late" },
            { sentence: "Try again.", translation: "/다시/ 해봐요.", w: "again" },
        ]
    }
]
