...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "This is a good idea.", translation: "이건 /좋은/ 생각이에요.", w: "good" },
            { sentence: "This is my last cookie.", translation: "이게 내 /마지막/ 쿠키예요.", w: "last" },
            { sentence: "Do it now.", translation: "/지금/ 하세요.", w: "now" },
            { sentence: "I cook rice.", translation: "나는 밥을 /요리/해요.", w: "cook" },
            { sentence: "Lunch is ready.", translation: "/점심/이 준비됐어요.", w: "lunch" },
            { sentence: "See you next time.", translation: "/다음/에 또 봐요.", w: "next" },
            { sentence: "I eat breakfast.", translation: "나는 /아침밥/을 먹어요.", w: "breakfast" },
        ]
    }
]
