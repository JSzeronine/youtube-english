...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "Hello, my friend!", translation: "/안녕/, 내 친구!", w: "hello" },
            { sentence: "Come here, please.", translation: "/여기/로 오세요.", w: "here" },
            { sentence: "I love my mom.", translation: "나는 /엄마/를 사랑해요.", w: "mom" },
            { sentence: "I see a dog.", translation: "나는 강아지를 /봐요./", w: "see" },
            { sentence: "The ball is there.", translation: "공이 /저기/에 있어요.", w: "there" },
            { sentence: "OK, let's go!", translation: "/좋아요,/ 가요!", w: "ok" },
            { sentence: "I drink milk.", translation: "나는 우유를 /마셔요./", w: "drink" },
        ]
    }
]
