...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "I wear my clothes.", translation: "나는 내 /옷을 입어요./", w: "clothes" },
            { sentence: "The ball is purple.", translation: "그 공은 /보라색이에요./", w: "purple" },
            { sentence: "I eat an orange.", translation: "나는 /오렌지를 먹어요./", w: "orange" },
            { sentence: "I know this game.", translation: "나는 이 게임을 /알아요./", w: "know" },
            { sentence: "My shoes are pink.", translation: "내 신발은 /핑크색이에요./", w: "pink" },
            { sentence: "The tree is green.", translation: "나무가 /초록색이에요./", w: "green" },
            { sentence: "See you later.", translation: "/나중에/ 봐요.", w: "later" },
        ]
    }
]
