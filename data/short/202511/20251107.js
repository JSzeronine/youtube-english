...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "He is rich.", translation: "그는 /부자/예요.", w: "rich" },
            { sentence: "The lady is nice.", translation: "그 /여자/는 착해요.", w: "lady" },
            { sentence: "I laugh with my friends.", translation: "나는 친구들과 /웃어요./", w: "laugh" },
            { sentence: "The bed is soft.", translation: "침대가 /부드러워요./", w: "soft" },
            { sentence: "That answer is wrong.", translation: "그 대답은 /틀렸어요./", w: "wrong" },
            { sentence: "The rock is hard.", translation: "돌은 /딱딱/해요.", w: "hard" },
            { sentence: "I like ice cream the most.", translation: "나는 아이스크림을 /가장/ 좋아해요.", w: "most" }
        ]
    }
]
