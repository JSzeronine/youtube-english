...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "I like to travel.", translation: "나는 /여행/을 좋아해요.", w: "travel" },
            { sentence: "The leaf is green.", translation: "/나뭇잎/이 초록색이에요.", w: "leaf" },
            { sentence: "The animal runs.", translation: "/동물/이 달려요.", w: "animal" },
            { sentence: "I see a fish.", translation: "/물고기/가 보여요.", w: "fish" },
            { sentence: "The flower is pink.", translation: "/꽃/이 분홍색이에요.", w: "flower" },
            { sentence: "I collect toys.", translation: "나는 장난감을 /모아요./", w: "collect" },
            { sentence: "I have enough food.", translation: "나는 음식이 /충분/해요.", w: "enough" },
        ]
    }
]
