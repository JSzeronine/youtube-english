...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "The snow is white.", translation: "눈은 /하얘요./", w: "white" },
            { sentence: "What color is it?", translation: "이건 무슨 /색/이에요?", w: "color" },
            { sentence: "A week has seven days.", translation: "/일주일/은 7일이에요.", w: "week" },
            { sentence: "The toy is in the box.", translation: "장난감이 상자 /안/에 있어요.", w: "in" },
            { sentence: "The cat is black.", translation: "그 고양이는 /검은색/이에요.", w: "black" },
        ]
    }
]
