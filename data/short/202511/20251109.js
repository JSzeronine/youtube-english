...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "The weather is nice today.", translation: "오늘 /날씨/가 좋아요.", w: "weather" },
            { sentence: "I wake up early.", translation: "나는 일찍 /일어나요./", w: "wake" },
            { sentence: "I see my shadow.", translation: "나는 내 /그림자/를 봐요.", w: "shadow" },
            { sentence: "Please be quiet.", translation: "제발 /조용히/ 해 주세요.", w: "quiet" },
            { sentence: "That sound is strange.", translation: "그 소리는 /이상해요./", w: "strange" },
            { sentence: "This puzzle is simple.", translation: "이 퍼즐은 /쉬워요./", w: "simple" },
            { sentence: "The food smells terrible.", translation: "그 음식은 냄새가 /나빠요./", w: "terrible" },
        ]
    }
]
