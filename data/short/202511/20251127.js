...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "When is dinner?", translation: "/언제/ 저녁이에요?", w: "when" },
            { sentence: "What is this?", translation: "이게 /뭐예요?/", w: "what" },
            { sentence: "Who is she?", translation: "그녀는 /누구/예요?", w: "who" },
            { sentence: "Please open the door.", translation: "문 좀 /열어주세요./", w: "open" },
            { sentence: "Did you hear that?", translation: "그거 /들었어요?/", w: "hear" },
        ]
    }
]
