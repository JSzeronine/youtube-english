...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "Don’t worry.", translation: "/걱정/하지 마세요.", w: "worry" },
            { sentence: "I read a book.", translation: "나는 책을 /읽어요./", w: "read" },
            { sentence: "I study ABC.", translation: "나는 ABC를 /공부해요./", w: "study" },
            { sentence: "The show will end soon.", translation: "쇼가 곧 /끝나요./", w: "end" },
            { sentence: "I wash my hands.", translation: "나는 손을 /씻어요./", w: "wash" },
        ]
    }
]
