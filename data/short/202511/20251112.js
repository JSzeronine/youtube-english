...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "I eat an apple.", translation: "나는 사과를 /먹어요./", w: "eat" },
            { sentence: "I am hungry.", translation: "나는 /배가 고파요./", w: "hungry" },
            { sentence: "Say hello!", translation: "안녕이라고 /말해요!/", w: "say" },
            { sentence: "I am thirsty.", translation: "나는 /목말라요./", w: "thirsty" },
            { sentence: "Push the door.", translation: "문을 /밀어요./", w: "push" },
            { sentence: "Stand up, please.", translation: "/일어나세요./", w: "stand" },
            { sentence: "Speak slowly, please.", translation: "천천히 /말해요./", w: "speak" },
        ]
    },
    {
        word: "Repeat",
        translation: "복습해볼게요.",
        words: [
            { sentence: "Let’s eat together.", translation: "같이 /먹어요./", w: "eat" },
            { sentence: "Are you hungry?", translation: "/배고프니?/", w: "hungry" },
            { sentence: "Say my name.", translation: "내 이름을 /말해요./", w: "say" },
            { sentence: "He is thirsty after play.", translation: "놀고 나서 /목말라요./", w: "thirsty" },
            { sentence: "Push the button.", translation: "버튼을 /눌러요./", w: "push" },
            { sentence: "Stand by me.", translation: "내 옆에 /서 있어요./", w: "stand" },
            { sentence: "Can you speak English?", translation: "영어로 /말/할 수 있나요?", w: "speak" },
        ]
    }
]
