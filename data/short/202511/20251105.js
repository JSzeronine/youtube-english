...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "I go to kindergarten.", translation: "나는 /유치원/에 가요.", w: "kindergarten" },
            { sentence: "It might rain today.", translation: "오늘 비가 /올지도/ 몰라요.", w: "might" },
            { sentence: "The toy is free.", translation: "그 장난감은 /공짜/예요.", w: "free" },
            { sentence: "The bag is heavy.", translation: "가방이 /무거워요./", w: "heavy" },
            { sentence: "You must wash your hands.", translation: "손을 /꼭/ 씻어야 해요.", w: "must" },
            { sentence: "I see a hospital.", translation: "/병원/이 보여요.", w: "hospital" },
            { sentence: "Water is important.", translation: "물은 /중요/해요.", w: "important" },
        ]
    }
]
