...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "I ate half of the apple.", translation: "나는 사과의 /반을/ 먹었어요.", w: "half" },
            { sentence: "The fire is dangerous.", translation: "불은 /위험/해요.", w: "dangerous" },
            { sentence: "The flag is red and blue.", translation: "그 /깃발/은 빨강과 파랑이에요.", w: "flag" },
            { sentence: "I could help you.", translation: "나는 너를 도와줄 /수도 있어요./", w: "could" },
            { sentence: "It may rain today.", translation: "오늘 비가 /올지도 몰라요./", w: "may" },
            { sentence: "Can I have more juice?", translation: "주스를 /더/ 마셔도 돼요?", w: "more" },
            { sentence: "Be silent, please.", translation: "/조용히/ 해 주세요.", w: "silent" },
        ]
    }
]
