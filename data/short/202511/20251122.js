...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "Yesterday was fun.", translation: "/어제/는 재미있었어요.", w: "yesterday" },
            { sentence: "Dinner is ready.", translation: "/저녁/이 준비됐어요.", w: "dinner" },
            { sentence: "I’m fine.", translation: "나 /괜찮아요./", w: "fine" },
            { sentence: "Nice to meet you.", translation: "/만나서/ 반가워요.", w: "meet" },
            { sentence: "I buy an apple.", translation: "나는 사과를 /사요./", w: "buy" },
            { sentence: "The ball is red.", translation: "그 공은 /빨간색/이에요.", w: "red" },
            { sentence: "The moon is bright.", translation: "/달/이 밝아요.", w: "moon" },
        ]
    }
]
