...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "Can you share your toy?", translation: "너 장난감 좀 /공유/해줄래?", w: "share" },
            { sentence: "Don’t leave me.", translation: "나를 /두고 가지 마./", w: "leave" },
            { sentence: "Let’s start now.", translation: "지금 /시작/하자.", w: "start" },
            { sentence: "Where are you going?", translation: "/어디/ 가니?", w: "where" },
            { sentence: "Show me your drawing.", translation: "너 그림 좀 /보여줘./", w: "show" },
        ]
    }
]
