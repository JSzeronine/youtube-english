...
const repeat = [
    {
        ...
        translation: "복습해볼게요.",
        words: [
            { sentence: "Wait for me.", translation: "나를 /기다려요./", w: "wait" },
            { sentence: "Throw the ball.", translation: "공을 /던져요./", w: "throw" },
            { sentence: "I wear my hat.", translation: "나는 모자를 /써요./", w: "wear" },
            { sentence: "Watch the puppy.", translation: "강아지를 /봐요./", w: "watch" },
            { sentence: "Stay here.", translation: "여기 /있어요./", w: "stay" },
            { sentence: "The flower died.", translation: "꽃이 /죽었어요./", w: "died" },
            { sentence: "Look at me!", translation: "나를 /봐요!/", w: "look" },
        ]
    },
    {
        word: "Repeat",
        translation: "복습해볼게요.",
        words: [
            { sentence: "Wait a minute.", translation: "잠깐만 /기다려요./", w: "wait" },
            { sentence: "Throw it to me.", translation: "그걸 나한테 /던져요./", w: "throw" },
            { sentence: "I wear my shoes.", translation: "나는 신발을 /신어요./", w: "wear" },
            { sentence: "Watch the bird.", translation: "저 새를 /봐요./", w: "watch" },
            { sentence: "Stay with me.", translation: "나와 같이 /있어요./", w: "stay" },
            { sentence: "The bug died.", translation: "벌레가 /죽었어요./", w: "died" },
            { sentence: "Look over there!", translation: "저기 /봐요!/", w: "look" },
        ]
    }
]
